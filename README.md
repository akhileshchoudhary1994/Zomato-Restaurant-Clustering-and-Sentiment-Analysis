...
# Used K-Means and Herarchical algorithm for clustering 

# Silhouttee and elbow analysis for determining optimum clusters

# For sentiment analysis used nltk library for text preprocessing and used tf-Idf and Bag of Words for vectorizing 
